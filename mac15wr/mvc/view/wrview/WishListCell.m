...
- (void)initdata
{
    ...
    //    self.detialView.cellDelegate = self;
    ...
    self.courseTypeLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, 80, 44)];
