...
- (void)layoutSublayers {
    ...
    self.path = [self drawPathWithArcCenter:0];
    self.progressLayer.path = [self drawPathWithArcCenter:-8];
...
- (void)setupLayer {
    ...
    self.path = [self drawPathWithArcCenter:0];
    self.fillColor = [UIColor cloudsColor].CGColor;
    self.strokeColor = [UIColor alizarinColor].CGColor;//[UIColor colorWithRed:0.86f green:0.86f blue:0.86f alpha:0.4f].CGColor;
    self.lineWidth = 20;
...
- (CGPathRef)drawPathWithArcCenter:(CGFloat)offset {
